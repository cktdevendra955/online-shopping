...
const Product = () => {
  ...
  return (
    <>
      ...
      <div className="min-h-screen mx-auto bg-white rounded-lg border shadow-md p-4 dark:bg-gray-800 dark:border-gray-700">
        <div className="w-full flex justify-between items-center mb-3 mt-1 ">
          <div>
            <h3 className="text-lg font-semibold text-slate-800">Products</h3>
            <p className="text-slate-500 text-sm small">List of Products</p>
          </div>
          <div className="ml-3">
