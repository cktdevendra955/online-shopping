...
const Product = () => {
  return (
    <>
      {/* <div className="bg-white p-8 rounded-md w-full bg-white rounded-lg border shadow-md sm:p-8 dark:bg-gray-800 dark:border-gray-700">
      ...
      <div className="mx-auto">
        <div className=" flex items-center justify-between p-2 ">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="lg:ml-40 ml-10 space-x-8">
              <Link href={"product/create"} className="bg-black px-4 py-2 rounded-md text-white font-semibold tracking-wide cursor-pointer">
                Create
              </Link>
            </div>
          </div>
